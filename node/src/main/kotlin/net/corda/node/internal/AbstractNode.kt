...
abstract class AbstractNode<S>(val configuration: NodeConfiguration,
    ...
    private fun obtainIdentities(trustRoot: X509Certificate): Triple<PartyAndCertificate, PartyAndCertificate?, Set<KeyAndAlias>> {
        ...
        val myNotaryIdentity = configuration.notary?.let {
            if (it.serviceLegalName != null) {
                val (notaryIdentity, notaryIdentityKeyPairs) = loadNotaryClusterIdentity(it.serviceLegalName)
    ...
    private fun loadNotaryClusterIdentity(serviceLegalName: CordaX500Name): Pair<PartyAndCertificate, Set<KeyAndAlias>> {
